...
import net.idt.trunkmon.Communicator1;
...
public class MultiSelectionSpinner_thresholds extends Spinner implements
    ...
    public MultiSelectionSpinner_thresholds(Context context) {
        super(context);
    ...
    public MultiSelectionSpinner_thresholds(Context context, AttributeSet attrs) {
        super(context, attrs);
